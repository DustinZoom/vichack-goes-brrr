...
import 'voting_page_model.dart';
export 'voting_page_model.dart';

class VotingPageWidget extends StatefulWidget {
  const VotingPageWidget({
    super.key,
    this.voteName,
  });
  ...
  @override
  State<VotingPageWidget> createState() => _VotingPageWidgetState();
}

class _VotingPageWidgetState extends State<VotingPageWidget>
    with TickerProviderStateMixin {
  late VotingPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VotingPageModel());
                      ...
                      Container(
                        ...
                        child: Padding(
                          padding: const EdgeInsetsDirectional.fromSTEB(
                              16.0, 0.0, 0.0, 0.0),
                          child: Text(
                            'Below is a summary of what this vote is about.',
